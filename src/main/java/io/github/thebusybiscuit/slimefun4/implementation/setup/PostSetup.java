...
public final class PostSetup {
    ...
    public static void loadItems() {
        ...
        sender.sendMessage("");
        sender.sendMessage(ChatColor.GREEN + " - Source:       https://github.com/womzil/Slimefun4");
        sender.sendMessage(ChatColor.GREEN + " - Bug Reports:  https://github.com/womzil/Slimefun4/issues");
